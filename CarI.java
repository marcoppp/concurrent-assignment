...
interface CarI {
    ...
    // Sets pos as destination and awaits arrival to this
    public void driveTo(Pos pos) throws InterruptedException;


    /* Below methods for asynchronous driving are supposed to be used only in Step 6 */

    // Adds pos as an extension to the current route (potentially defining a new one).
    // Returns an id for this destination.
